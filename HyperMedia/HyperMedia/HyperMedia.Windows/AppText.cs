...
namespace HyperMedia
{
    public sealed class AppText : INotifyPropertyChanged
    {
        ...
        private void BuildDictionary()
        {
            ...
            Add("PhotoFit", "适应", "Fit");
            Add("ImageTooLargeFilter", "图片过大，跳过滤镜", "Image too large, filter skipped");
            Add("ExifDimensions", "尺寸", "Dimensions");
            Add("ExifSize", "文件大小", "File size");
            Add("ExifDateTaken", "拍摄时间", "Date taken");
            Add("ExifCamera", "相机", "Camera");
            Add("ExifModel", "型号", "Model");
            Add("ExifLens", "镜头", "Lens");
            Add("ExifExposure", "曝光", "Exposure");
            Add("ExifAperture", "光圈", "Aperture");
            Add("ExifIso", "感光度", "ISO");
            Add("ExifFocal", "焦距", "Focal length");
            Add("ExifFlash", "闪光灯", "Flash");
            Add("ExifWhiteBalance", "白平衡", "White balance");
            Add("ExifOrientation", "方向", "Orientation");
            Add("ExifBias", "曝光补偿", "Exposure bias");
            Add("ExifMetering", "测光", "Metering");
            Add("ExifProgram", "拍摄模式", "Program");
            Add("ExifFocalFilm", "等效焦距", "Focal length (35mm)");
            Add("ExifColorSpace", "色彩空间", "Color space");
            Add("ExifGps", "GPS", "GPS");
            Add("ExifComment", "备注", "Comment");
            Add("FlashOn", "闪光", "Fired");
            Add("FlashOff", "未闪光", "No flash");
            Add("WbAuto", "自动", "Auto");
            Add("WbManual", "手动", "Manual");
            Add("EditCrop", "裁剪", "Crop");
            Add("EditCropDone", "完成裁剪", "Apply Crop");
            Add("EditSaved", "图片已保存", "Image saved");
            Add("EditSaveFailed", "保存失败: ", "Save failed: ");
            ...
            Add("LyricSource", "歌词来源", "Lyrics Source");
            Add("LyricSourceLabel", "来源:", "Source:");
            Add("LyricSourceShortAuto", "自动", "Auto");
            Add("LyricSourceShortNetease", "网易云", "Netease");
            Add("LyricSourceShortQq", "QQ", "QQ");
            Add("IdentifyTitle", "听歌识曲", "Identify Song");
            Add("IdentifyFailed", "识别失败：无法提取音频或服务不可用", "Identify failed: audio unavailable or service error");
            Add("IdentifyNoMatch", "未识别出歌曲，请尝试更长的音频片段或清晰录音", "No match found. Try a longer or clearer audio clip");
            Add("IdentifyPlay", "播放此文件", "Play this file");
            Add("MetaEdit", "编辑元数据", "Edit Metadata");
            Add("MetaEditTitle", "元数据编辑器", "Metadata Editor");
            Add("MetaTitle", "标题", "Title");
            Add("MetaArtist", "艺术家", "Artist");
            Add("MetaAlbum", "专辑", "Album");
            Add("MetaDate", "日期", "Date");
            Add("MetaCollecting", "正在从公开平台收集元数据...", "Collecting public metadata...");
            Add("MetaCollected", "已从平台获取元数据", "Metadata collected from platform");
            Add("MetaCollectFailed", "未找到公开元数据，可手动填写", "No public metadata found - edit manually");
            Add("MetaSave", "保存标签", "Save Tags");
            Add("MetaSaved", "已保存", "Saved");
            Add("MetaSaveFailed", "保存失败：该格式可能不支持写标签", "Save failed: format may not support tag writing");
            Add("DescLyricSource", "选择在线歌词的获取来源（无本地歌词时生效）", "Online lyrics source (when no local lyrics exist)");
            ...
            Add("PerfHardDecode", "硬件解码", "Hardware Decode");
            Add("HardH264No", "H.264 不支持", "H.264 unavailable");
            Add("HardH264Yes", "H.264 支持", "H.264 available");
            Add("HardHevcNone", "H.265 不支持", "H.265 unavailable");
            Add("HardHevc8", "H.265 8bit", "H.265 8-bit");
            Add("HardHevc10", "H.265 10bit", "H.265 10-bit");
